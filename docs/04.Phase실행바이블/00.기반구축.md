...
> **바이블 Phase 00 — 기반구축**  
> 선행: `없음` · 종료 Gate: `전체 모노레포 기동, 샘플 FE/BE 연동`  
> 교보재 원본: `phase_00_foundation.md`  
> 규칙: **한 세션 = 이 Phase만** · Gate 실패 시 다음 Phase 금지  
> 완료 보고: `docs/06.완료보고/PHASE-00.md` (템플릿: `docs/05.템플릿/01.Phase완료보고서.md`)  
...
`docs/06.완료보고/PHASE-00.md`를 작성하라.
