...
> **바이블 Phase 15 — HITL승인**  
> 선행: `12~14` · 종료 Gate: `자동 PASS와 고객 승인 분리, Audit Trail 저장`  
> 교보재 원본: `phase_15_hitl.md`  
> 규칙: **한 세션 = 이 Phase만** · Gate 실패 시 다음 Phase 금지  
> 완료 보고: `docs/06.완료보고/PHASE-15.md` (템플릿: `docs/05.템플릿/01.Phase완료보고서.md`)  
...
`docs/06.완료보고/PHASE-15.md`를 작성하라.
