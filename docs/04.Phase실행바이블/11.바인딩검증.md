...
> **바이블 Phase 11 — 바인딩검증**  
> 선행: `09, 10` · 종료 Gate: `Input↔Request↔Response↔UI 값 비교`  
> 교보재 원본: `phase_11_binding_validation.md`  
> 규칙: **한 세션 = 이 Phase만** · Gate 실패 시 다음 Phase 금지  
> 완료 보고: `docs/06.완료보고/PHASE-11.md` (템플릿: `docs/05.템플릿/01.Phase완료보고서.md`)  
...
`docs/06.완료보고/PHASE-11.md`를 작성하라.
