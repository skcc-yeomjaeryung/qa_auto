...
const sample = resolve(import.meta.dirname, "../../../sample-targets/customer-portal-fe");

describe("sample-targets customer-portal-fe gate", () => {
  it("extracts A search, customerId rules, POST search, B route, playwright", () => {
    ...
    // unresolved must be explicit array (may be empty)
